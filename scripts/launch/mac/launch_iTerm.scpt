on run argv
    ...
    tell application "iTerm"
        ...
        write T's session 1 text "pnpm --filter flint-web -C \"" & ProjectRoot & "\" start" & REGION
        write T's session 2 text "pnpm --filter flint-components -C \"" & ProjectRoot & "\" start" & REGION
    end tell
end run
